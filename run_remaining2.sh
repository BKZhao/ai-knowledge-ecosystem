...
echo "===== Build Features ====="
python3 build_features_simple.py

echo "===== 01 Descriptive ====="
PYTHONPATH=. python3 src/analysis/01_descriptive.py --features data/features/ --output results/figures/descriptive/ 2>&1 | tail -30
